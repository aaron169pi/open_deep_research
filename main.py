...
from container_manager import DockerAppManager
...
def process_app_idea(idea: str):
    ...
    with DockerAppManager(project_dir="tempo") as container_manager:
        ...
        while True:
            ...
            for batch in batch_files(code_changes_data, batch_size=4):
                ...
                updated_code_data = []
                for file_response in validated_code_response[
                    "structured_response"
                ].items:
                    file_dict = {
                        "file_path": file_response.file_path,
